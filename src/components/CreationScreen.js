    ...
    render(){
        return (
            <View style={{width : this.state.width, height : this.state.height}}>
                ...
                {/* Tombol Tambah */}
                <TouchableOpacity style={{height : 50, width : 50, position : 'absolute',bottom : 50, right : 25,backgroundColor : 'white', borderRadius: 50 / 2, overflow: "hidden", borderWidth: 3, alignItems : "center"}}>
